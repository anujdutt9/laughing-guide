...
# TEST: --model "Qwen/Qwen2-0.5B-Instruct" --task "hallueval" --device "cuda" --n 160 --add_question --num_fewshot_examples 5 --n_contrastive_samples 200 --encoding_method "instruct" --add_generation_prompt --sample_selection_method "distance" --batch_size 32 --output_dir "hallueval_activation_steering" --max_new_tokens 512
